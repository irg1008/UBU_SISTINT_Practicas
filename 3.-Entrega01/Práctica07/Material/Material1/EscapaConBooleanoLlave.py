...
"""
class State:
    def __init__(self,player,piedra,agua,aspa,llave,booleanollave):
        ...
        self.aspa = aspa
        self.llave = llave
        self.booleanollave = booleanollave
    ...
    def __str__(self):
        ...
        Ninguno
        """   
        return str(self.player)+str(self.piedra)+str(self.agua)+str(self.aspa)+str(self.llave)+str(self.booleanollave)
    ...
    def __eq__(self,other):
        return all([self.player == other.player,
                    ...
                    self.booleanollave == other.booleanollave])
