...
def getJuego(filename):
    ...
    noMapa = set([]) # Aquí, identificas si la línea correspondiente no "pertenece" al Tablero.
    ancho=functools.reduce(max,map(len,lineas))-1 # Aquí, generas una lista que tiene el valor de la longitud de cada línea, y obtienes el
    ...
    for linea in lineas:
            ...
            fila = list(itertools.repeat(0, ancho)) # Aquí generas una fila de ceros que, más abajo, irás rellenando "como corresponda".
